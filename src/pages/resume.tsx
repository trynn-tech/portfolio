...
const Resume: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="h-full relative bg-[#031e11] px-32 text-[#aaa]">
        ...
        <div className="flex ml-8 space-x-32 fill-current mb-4">
          ...
          <p>Aliases: Trynn, Triscuit, Mr.T<br className="mb-2"/>
              D.O.B: March 23, 1997<br className="mb-2"/>
            ...
            <div className="mb-8">
              ...
              <div className="my-5">
                ...
                <ul className="list-disc ml-10">
                  ...
                  <li>Contracted by The Eleven Group to make front end designs compatible with search engine optimization best-practices in Angular for Interstate Batteries increasing.</li>
